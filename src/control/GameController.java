            ...
            if(pacman.overlap(eTemp)){
                if(eTemp.isTransposable() && eTemp.isMortal()){
                    ...
                    if (eTemp instanceof Ghost) {
						...
						pacman.addScore(pacman.getScoreToAddFromKillingGhost());
						pacman.addRemainingScore(pacman.getScoreToAddFromKillingGhost());
						pacman.setScoreToAddFromKillingGhost(pacman.getScoreToAddFromKillingGhost() * 2);
					}
